...
(function ($, window, document, undefined) {
    var EZP = {
        ...
        startZoom: function () {
            ...
            if (self.options.scrollZoom) {
                ...
                self.zoomContainer.add(self.$elem).bind('wheel DOMMouseScroll MozMousePixelScroll', function (e) {
                    ...
                    if (theEvent / 120 > 0) { //modified by pinger
        ...
        setPosition: function (e) {
            ...
            self.zoomContainer.css({
                // top: self.nzOffset.top, //original
                top: '0px',
                // left: self.nzOffset.left, //original
                left: '0px',
        ...
        doneCallback: function () {
            ...
            if (self.options.zoomType === 'window') {
				...
				//edited for when swap the image, the zoom lens will get the correct size
				if (self.nzHeight < self.options.zoomWindowHeight / self.heightRatio) {
                    self.lensHeight = self.nzHeight;
                }
                else {
    ...
    $.fn.ezPlus.options = {
        ...
        // onShow: $.noop,
		onShow: function(self) { //edited for fix small image zoom
			var img = new Image;
        ...
        // zoomContainerAppendTo: 'body', //original
        zoomContainerAppendTo: 'section#product-product div#main-content div#product-frame div.img-main', //zoom container parent selector
